            ...
            <div>
                <div className="landing-grid">
                    ...
                    <div className="aboutInfo">
                        ...
                        <hr />
                        <p className="aboutText">Hey my name is Josh McNeill and I am a North Carolina based web developer who loves to create beautiful and clean web applications. It is a true passion of mine to be able to take a webpage, apply my creativity to it and turn it into something great. Let's create greatness together.  </p>
                    </div>
